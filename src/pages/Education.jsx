      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-5">
            {research.map((r, i) => (
              <div key={r.title}
                className="bg-light rounded-2xl p-7 border border-gray-100 card-hover
                           animate-fade-up flex flex-col sm:flex-row gap-5"
                style={{ animationDelay: `${i * 80}ms` }}>
                <div className="sm:w-28 shrink-0 text-center sm:text-left">
                  <p className="text-xs font-body font-medium text-deep-green">{r.year}</p>
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs font-body text-dark/45 mb-3">{r.institution}</p>
                  <p className="text-sm font-body text-dark/65 leading-relaxed">{r.abstract}</p>
                </div>
              </div>
            ))}
          </div>
